...
import br.com.trustly.schulz.backendchallenge.gitadapter.JsoupGitHubImplAdapter;
 ...
 */
@Service
public class SoupGitHubRepositoryInformationService extends AbstractBaseInformationService {

	private String workspace;
	private String repository;

	@Autowired
	public SoupGitHubRepositoryInformationService() {
		super();
	}
	...
	protected RepositoryAdapter getGitAdapter() {
		return new JsoupGitHubImplAdapter("https://github.com/".concat(workspace).concat("/").concat(repository));
	}
