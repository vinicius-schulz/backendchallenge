...
import br.com.trustly.schulz.backendchallenge.gitadapter.JgitGitHubImplAdapter;
 ...
 */
@Service
public class JgitGitHubRepositoryInformationService extends AbstractBaseInformationService {

	private String workspace;
	private String repository;

	@Autowired
	public JgitGitHubRepositoryInformationService() {
		super();
	}
